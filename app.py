...
def dashboard():
    ...
    pengumuman_data = list(pengumumans.find())
    target_data = list(targets.find())
    pelanggaran_data = list(pelanggarans.find())
    return render_template("dashboard.html", user=user, pengumuman=pengumuman_data, target=target_data, pelanggaran=pelanggaran_data)
